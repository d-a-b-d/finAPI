...
exports.createAccount = async (req, res) => {
    try {
      ...
      const parsedBalance = parseFloat(initialBalance); // Parse the initial balance as a number
  ...
  exports.transferMoney = async (req, res) => {
    ...
    try {
      ...
      try {
        ...
        const destinationAccount = await Account.findByPk(destinationAccountId, { transaction });
